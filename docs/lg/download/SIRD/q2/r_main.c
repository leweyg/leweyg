...
void R_Register (void)
{
	...
	//Start Added by Lewey
	sw_drawsird = ri.Cvar_Get ("sw_sird", "1", 0);
	sw_drawsirdlayers = ri.Cvar_Get ("sw_sirdlayers", "0", 0);
	//End Added by Lewey
