...
var partnerImageSrcBase = "subject/cacao/ref_images/";
var partnerRemoteServerBase = "https://www.yellow-seed.org/";
var partnerRemoteBackend = "https://www.yellow-seed.org/";
var partnerInfoLink = "<a href='" + partnerRemoteServerBase + "'>Yellow Seed</a>";

function partnerGeneralInfo() {
	return {
		bgImagePath : "subject/cacao/bali_evening_village.jpg", //"images/sunset_360.jpg",
		scrollImagePath : "subject/cacao/map_brazil.png",
	};
}
